...
<div style="left:50%;top:0px;width:655px;height:940px; overflow:hidden">
    <div style="left:0px;top:0px">
        ...
        <div class="cls_002"><span class="cls_002">АО Международного университета информационных технологий</span></div>
        ...
        <div class="cls_002"><span class="cls_002">Срок обучения в учебном заведении {{$data->course_count}} года</span></div>
        <div class="cls_002"><span class="cls_002">Период обучения с {{$data->start_date}} г. по {{$data->end_date}} г.</span></div>
